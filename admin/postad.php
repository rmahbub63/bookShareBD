                     ...
                     <form action="" method="post" class="submit-form" enctype="multipart/form-data">
                        ...
                        <div class="row">
                           <div class="col-md-6 col-lg-6 col-xs-12 col-sm-12">
                              ...
                              <input id="" id="name" name="user_name" class="form-control" placeholder="ex. Mahbubur Rahman" type="text" readonly value="<?= $user['name'] ?>">
                           </div>
                           <div class="col-md-6 col-lg-6 col-xs-12 col-sm-12">
                              <label class="control-label">Your Email ID<small>where you receive your emails</small></label>
                              <input id="email" name="user_email" class="form-control" placeholder="ex. rmahbub63@gmail.com" type="text" readonly value="<?= $user['email'] ?>">
                           </div>
                        </div>
                        <!-- end row -->
                        <div class="row">
                           <div class="col-md-6 col-lg-6 col-xs-12 col-sm-12">
                              ...
                              <input id="phone" name="user_phone" class="form-control" placeholder="ex. 01234567891" type="text" readonly value="<?= $user['contact_number'] ?>">
                           </div>
                           <div class="col-md-6 col-lg-6 col-xs-12 col-sm-12">
                              <label class="control-label">Address<small>your current address</small></label>
                              <input id="address" name="user_address" class="form-control" placeholder="ex. 108/2, Sankar, Dhanmondi" type="text" value="<?= $user['address'] ?>" required>
                           </div>
                        </div>
                  ...
                  <div class="blog-sidebar">
                     ...
                     <div class="widget">
                        ...
                        <div class="widget-content">
                           <p class="lead">Posting an ad on <a href="#">BookShareBD</a> is free! However, all ads must follow our rules:</p>
                           <ol>
